package pers.ycy.myshop.service.upload.fastdfs;
...
public class FastDFSStorageService implements StorageService, InitializingBean {
    ...
    public String upload(byte[] data, String extName) {
        ...
        try {
            ...
            serviceClose(trackerServer, storageServer);
        }
    }
    ...
    private void serviceClose(TrackerServer trackerServer, StorageServer storageServer) {
